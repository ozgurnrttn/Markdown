...
```
Yukarıdaki örnekte yer alan **AirPassenger** zaman serisinin, zamana bağlı olarak trendinin büyüdüğü ve mevsimsel döngülerinin aralıklarının değiştiği görülmektedir.
...
```{r}
plot(AirPassengers)  #Quarterly Time Series of the Number of Australian Residents
plot(JohnsonJohnson)  #Quarterly Earnings per Johnson & Johnson Share
...
```{r}
nottem_random=decompose(nottem)$random   #Average Monthly Temperatures at Nottingham, 1920–1939
